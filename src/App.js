...
import AboutImage from "../assets/Profie.png";
...
export default function App(){
 ...
 <section class="container" >
  ...
  <h1 class="text-black text-4xl font-bold md:text-5xl mb-4 md:mb-5 text-center md:text-left">Project</h1>
   ...
   <div className="mt-8 mx-auto max-w-7xl grid md:grid-cols-3 ">
  <div  className="max-w-sm rounded overflow-hidden shadow-lg mx-auto p-4">
    <img  className="w-full" src="/images/project1.PNG" alt="Sunset in the mountains"/>
    <div>
    ...
    <div  className="pt-2 pb-2">
      <span  className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Laravel Blade </span>
      <span  className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Html </span>
      <span  className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Bootsrap</span>
      <span  className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Css</span>
    </div>
  </div>

  <div  className="max-w-sm rounded overflow-hidden shadow-lg mx-auto p-4">
    <img  className="w-full" src="/images/dashboard.jpg" alt="Sunset in the mountains"/>
    <div>
      <div  className="font-bold text-xl mb-2">Backend Develepment</div>
      <p  className="text-gray-700 text-base">
       Using laravel 9/10  bulid dashboard  for new bussiness to manage update records , Also make Laravel Api as backend services for any Frontend Technoiogies such as React .
      </p>
    </div>
    <div  className="pt-2 pb-2">
  ...
  <div  className="max-w-sm rounded overflow-hidden shadow-lg mx-auto p-4">
    <img  className="w-full" src="/images/images.png" alt="Sunset in the mountains"/>
    <div>
      <div  className="font-bold text-xl mb-2">Learning  New Technoiogies </div>
      <p  className="text-gray-700 text-base">
        As a Developer  Learning phase  is  always Continue through out  So At the time i am working React Framework To make Frontend of sites and  using laravel as Backend
      </p>
    </div>
    <div  className="pt-2 pb-2">
      ...
      <span  className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Laravel Api</span>
    </div>
  </div>
</div>
</section>
                        ...
                        <ul class="mt-12 space-y-8">
                            <li class="flex items-center">
                                ...
                                <a href="javascript:void(0)" class="text-white text-sm ml-3">
                                    <strong>abdullahabbasihafiz123@gmail.com</strong>
                                </a>
                            </li>
                            <li class="flex items-center">
